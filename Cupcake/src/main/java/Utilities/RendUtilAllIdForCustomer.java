...
//            sb.append("<td>\n <input type=\"hidden\" name=\" orderid\" value=\""+o.getOrder_id()+"\"><br>\n\n</td>"); //location.href='invoice_detail.jsp';\
    ...
    public static String allInvoiceIdTabelCustomerToAdmin(List<Order> allId) {
    StringBuilder sb = new StringBuilder();
        sb.append("<table>\n"
                + "<tr><th></th><th></th></tr>\n"
         + "<tr><th>InvoiceId</th><th>Date</th><th></th></tr>\n");
...
//            sb.append("<td>\n <input type=\"hidden\" name=\" orderid\" value=\""+o.getOrder_id()+"\"><br>\n\n</td>"); //location.href='invoice_detail.jsp';\
        ...
        sb.append("</table>\n"); 
        sb.append("<button type=\"submit\" value=\"action\" name=invoice_detailAdmin\">See order</button> " );
        sb.append("</form>\n");
        return sb.toString();
